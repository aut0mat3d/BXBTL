...
#define REG_BATTERY_STATUS_CELLPACK_CURRENT_HI                 0x1E //Reading battery current by a shunt resistor. No delay, no calibration compared to battery.gg.ai [unit:A, factor:0.001] since="rev.hw count 60" type="scalar" unit="A" factor="0.001" signed="yes" volatile="yes">
...
#define REG_BATTERY_STATISTIC_BATTERY_AVGVOLTAGE_NORMALIZED    0x33 //Average battery voltage read during 50s based on battery.status.vBatt, in percentage of its nominal voltage [unit:%, factor:0.416667, offset:20.8333]
